...
def main()->int:
    parser=argparse.ArgumentParser();parser.add_argument('output',nargs='?',default=str(ROOT.parent/'MonoOLED_Studio_v8.4.2_Automation_Reliability_GA_Closure_Complete_Delivery_2026-08-24.zip'));args=parser.parse_args()
