...
class OLEDCanvas(QWidget):
    ...
    def set_guides(self, guides) -> None:
        self._guides={'x':tuple(guides.get('x',())), 'y':tuple(guides.get('y',()))}; self.update()
