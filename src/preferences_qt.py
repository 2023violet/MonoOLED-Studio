...
class PreferencesView(QWidget):
    ...
    def _load_values(self):
        ...
        self._set_combo(self.theme_mode,self.store.get('appearance.theme_mode','light')); self._set_combo(self.density,self.store.get('appearance.density','comfortable')); self._set_combo(self.ui_scale,self.store.get('appearance.ui_scale','100%')); self.reduced_motion.setChecked(bool(self.store.get('appearance.reduced_motion',False)))
