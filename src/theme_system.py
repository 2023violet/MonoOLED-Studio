...
_THEMES = {
    'monooled-light': {
        'app.background': '#F4F5F7', 'surface.panel': '#FFFFFF', 'surface.canvas': '#ECEFF3', 'surface.toolbar': '#F8F9FB',
        'surface.hover': '#EFF1F4', 'surface.pressed': '#E3E6EA', 'surface.selected': '#E1EFFC',
        'text.primary': '#1D1D1F', 'text.secondary': '#5E5E63', 'text.muted': '#6E6E73', 'text.disabled': '#AEAEB2',
        'border.normal': '#C8CDD4', 'border.subtle': '#E0E3E8', 'border.focus': '#0A84FF',
    ...
    'monooled-dark': {
        'app.background': '#15161A', 'surface.panel': '#1D1F23', 'surface.canvas': '#111318', 'surface.toolbar': '#23262B',
        'surface.hover': '#2B2F35', 'surface.pressed': '#343940', 'surface.selected': '#173A5E',
