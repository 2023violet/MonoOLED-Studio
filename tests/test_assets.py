...
def test_load_mode_icon_as_strict_binary_bitmap():
    asset = load_bitmap(ROOT / 'test_assets/projects/curing_lite/assets/clinical_ui/normal.png')
...
def test_load_battery_asset_preserves_native_size():
    asset = load_bitmap(ROOT / 'test_assets/projects/curing_lite/assets/battery/11x28/battery_4.png')
...
def test_mode_font_decodes_column_major_bit0_top():
    font = load_mode_font(ROOT / 'test_assets/projects/curing_lite/assets/clinical_ui/english_5x7_v2/cl_font_mode_en_5x7_v2.h')
...
def test_existing_curing_lite_assets_normalize_white_background_to_off_pixels():
    digit = load_bitmap(ROOT / 'test_assets/projects/curing_lite/assets/digits/13x27/digit_0.png')
    icon = load_bitmap(ROOT / 'test_assets/projects/curing_lite/assets/clinical_ui/normal.png')
    battery = load_bitmap(ROOT / 'test_assets/projects/curing_lite/assets/battery/11x28/battery_4.png')
