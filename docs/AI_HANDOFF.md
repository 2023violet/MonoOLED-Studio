...
V1.2.1 不支持 GIF 导入、多帧 GIF 编辑或 GIF 导出。不要把测试夹具、规划中的功能或仅由 host 测试证明的行为写成已完成的硬件能力。

## 3. 当前可信基线

| 项目 | 当前基线 | 真源或验证方法 |
| --- | --- | --- |
| 产品版本 | `1.2.1` | `src/VERSION` |
| 正式标签 | `v1.2.1` → 待 GA 后发布 | `git show-ref -d refs/tags/v1.2.1` |
...
| Windows 发行物 | `MonoOLEDStudio_v1.2.1_Windows_x64.zip` | GA 后 GitHub Release `v1.2.1` |
| 发布 ZIP SHA-256 | 待 GA 产物生成 | Release sidecar 与附件 digest |

发布页：<https://github.com/2023violet/MonoOLED-Studio/releases/tag/v1.2.1>
