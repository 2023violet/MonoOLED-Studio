...
def main()->int:
    parser=argparse.ArgumentParser();parser.add_argument('output',nargs='?',default=str(ROOT.parent/'MonoOLED_Studio_v8.3_Reliability_Performance_Closure_Complete_Delivery_2026-08-23.zip'));args=parser.parse_args()
