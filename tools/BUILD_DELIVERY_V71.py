...
def main() -> int:
    p=argparse.ArgumentParser(); p.add_argument('output',nargs='?',default=str(ROOT.parent/'MonoOLED_Studio_v7.1_Product_Closure_Complete_Delivery_2026-08-23.zip')); args=p.parse_args()
